...
<div id="content">
    ...
    <div class="state">
        <span>当前状态：等待歌手到场</span>
        <div class="date">剩余：24小时00分00秒</div>
    </div>
    ...
    <div class="progressBar">
        <li class="on">
            ...
            <div class="promptText">已付款<br />06-08 15:00</div>
        </li>
        ...
        <li class="on">
            ...
            <div class="promptText">已接单<br />06-08 15:20</div>
        </li>
...
<div class="bookingHref">
    <a href="#" style="width:100%;" class="on">确认歌手到场</a>
</div>
</body>
</html>
