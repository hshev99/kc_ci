...
<div id="content">
    <div class="new">
        <ul>
            <li>
                <a href="message_detail">
                    <div class="garden1"><img src="<?php echo $css?>images/new.png" width="100%" /> &nbsp;</div>
                    <div class="text3">
                        <div class="tit1">系统消息</div>
                        <div class="notice">《我是歌手4》第二场踢馆赛强势来第二场踢馆赛强势来袭！王晰首...</div>
                        <div class="posi_time">
                            <div class="time1">07:15</div>
