...
<div class="banner" id="lbt"  style="margin-top: 50px;" >
    <div id="focus" class="focus">
        ...
        <div class="bd">
            <ul>
                <li><a href="#"><img src="http://123.57.56.133:90/241d3b30d4e810fbb1c96f4d7a1e52f1.png" /></a></li>
                <li><a href="#"><img src="http://123.57.56.133:90/4bbe0d438d4332596568951647617d4e.png" /></a></li>
                <li><a href="#"><img src="http://123.57.56.133:90/ed896bd3de45d77b9e2682390856cf62.jpg" /></a></li>
                <li><a href="#"><img src="http://123.57.56.133:90/8a853e1f742f1379d918828ea52b7f27.png" /></a></li>
                <li><a href="#"><img src="http://123.57.56.133:90/f93153263593bbbb1335dace3d3f3d9d.png" /></a></li>
                <li><a href="#"><img src="http://123.57.56.133:90/a89c50e1c28965de7337f9ef3a927123.png" /></a></li>
            </ul>
        </div>
    </div>
                ...
                <ul>
                    <?php foreach ($infos as $val){?>
                        ...
                        <div class="hearImg" style="width:75px;">
                            <a href="SingerHome?worker_uid=<?php echo $val['uid']?>"><img src="<?php if ($val['img']){echo $val['img'];}else{echo $css.'images/head_default_min.png';}?>" width="100%" />
                            <div class="posion"><img src="<?php echo @$css?>images/singer6.png" /></div></a>
                        </div>
                        <div class="right" style="margin-top:3px;">
                        <div class="singerNmae" style="padding-right:60px;">
                        <a href="SingerHome?worker_uid=<?php echo $val['uid']?>">
                            <span style="font-size:14px;"><?php echo @$val['name']?></span>
                            <span style="font-size:12px; padding-left:4px;"><?php echo @$val['nick']?></span>
                       	</a>
                        <div class="label">
            ...
            success: function(data){
                ...
                for(var i = 0; i < data.results.infos.length; i++){
                    ...
                    result += '<li class="item">'
                        ...
                        +'<div class="right" style="margin-top:3px;">'
                        +'<div class="singerNmae" style="padding-right:60px;">'
                        +'<a class="styName" href="SingerHome?worker_uid='+data.results.infos[i].uid+'  ">'
                        +'<span style="font-size:14px;"> '+data.results.infos[i].name+'</span>'
                        +'<span style="font-size:12px; padding-left:4px;">'+data.results.infos[i].nick+' </span>'
                        +'</a>'
                        +'<div class="label">'
                        + style_name
                        +'</div>'
    ...
    $(function(){
        ...
        $('.content').dropload({
            ...
            loadDownFn : function(me){
                if (LastData){alert("已加载完全部歌手信息了");return false;}
                    ...
                    success: function(data){
                        ...
                        for(var i = 0; i < data.results.length; i++){
                            ...
                            result += '<li class="item">'
                                ...
                                +'<div class="right" style="margin-top:3px;">'
                                +'<div class="singerNmae" style="padding-right:60px;">'
                                +'<a class="styName" href="SingerHome?worker_uid='+data.results[i].uid+'  ">'
                                +'<span style="font-size:14px;"> '+data.results[i].name+'</span>'
                                +'<span style="font-size:12px; padding-left:4px;">'+data.results[i].nick+' </span>'
                                +'</a>'
                                +'<div class="label">'
                                + style_name
                                +'</div>'
