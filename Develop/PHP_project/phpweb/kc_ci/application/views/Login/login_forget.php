...
<body>
<form action="login_back_web" method="post" onsubmit="return tijiao()">
<div id="header">
	<div class="top">
    	<div class="title">
        	找回密码
...
<div id="content">
	<div class="logIn">
    	<div class="Name">
            ...
            <input type="text" class="userN" name="phone" id="phone" onblur="blur_phone()" placeholder="请输入找回手机号" />
        </div>
        ...
        <input type="submit" value="确认找回密码" class="button" style="margin-top:0;" />
    </div>
</div>
    </form>
</body>
