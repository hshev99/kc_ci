...
$redis->connect('123.57.56.133', 6379);echo $redis->ping();exit();
$info=$redis->get($order_sn);
print_r($info);
?>
<!DOCTYPE html>
<html>
...
<div id="main">
        <form name=alipayment action=http://alipay-h5.51huole.cn/alipayapi.php method=post target="_blank">
